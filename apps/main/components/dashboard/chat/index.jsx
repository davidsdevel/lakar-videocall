...
export default function Messages() {
  ...
  return <div className='fixed w-full h-full top-0 left-0 flex flex-col md:flex-row'>
    <div className='md:w-1/3 bg-slate-400 z-10'>
      <div className='p-2 flex items-center bg-slate-700'>
        <button onClick={() => router.push('/messages')} disabled={isLoading}>
