...
export default function Features() {
  return <div className='py-12 text-center'>
    <div className='py-2 flex flex-col items-center px-4 md:flex-row'>
      ...
      <p className='font-bold text-gray-600 py-8 md:w-1/2 md:px-8 md:text-left'><span className='text-main-500'>Disfruta de llamadas</span> de audio y video con tus amigos.</p>
    </div>
    ...
    <div className='py-2 flex flex-col items-center px-4 md:flex-row'>
      <div className='bg-white py-12 rounded-lg w-full px-4 md:w-1/2'>
        <img src='/images/lakar-platforms.svg' className='max-w-xs m-auto' alt=''/>
      </div>
      <p className='font-bold text-gray-600 py-8 md:w-1/2 md:px-8 md:text-left'>Ingresa <span className='text-main-500'>desde cualquier dispositivo</span> y Mantente siempre en contacto</p>
    </div>
  </div>;
}
