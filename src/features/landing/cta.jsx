...
export default function CTA() {
	...
	return (
		<div className="w-11/12 bg-white m-auto py-8 px-4 flex flex-col items-center rounded-lg max-w-2xl">
			<p className="text-center bg-clip-text text-transparent text-2xl text-main-500 mb-8 font-extrabold bg-gradient-to-r from-green-400 to-main-500 md:my-16">
			...
			<div className="flex items-stretch">
				<a
					href="https://ko-fi.com/E1E7IJX9J"
					target="_blank"
					rel="noreferrer"
					className="mx-1"
				>
